...
pub use crate::util::{random_cen_165, random_f64_101, unit_vec};
...
pub fn final_scene() -> Vec<Object> {
    ...
    for i in 0..20 {
        for j in 0..20 {
            ...
            let z1 = z0 + w;
            v.push(Object::Tr(Translate::new(
                Rotatey::new(
                    0.0,
                    Boxx::new(Vec3::new(x0, y0, z0), Vec3::new(x1, y1, z1), ground, 1),
                ),
                zero,
            )))
        }
    ...
    let light = [7.0; 3];
    v.push(Object::Xz(Xzrect::new(
        123.0, 423.0, 147.0, 412.0, 554.0, light, 2,
    )));
    ...
    for _ in 0..1000 {
        ...
        sphere_box.add(Object::Sphere(Sphere {
            tp: (1),
            center: (c),
            destinity: (c),
            time1: (0.0),
    ...
    v.push(Object::Tr(Translate::new(
        Rotatey::new(std::f64::consts::PI / 12.0, sphere_box),
        offset,
    )));
